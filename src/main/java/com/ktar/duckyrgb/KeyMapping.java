...
public class KeyMapping {
    private static final Map<String, BytePosition[]> keyMap = new HashMap<>();
    ...
    public static BytePosition[] getBytePositions(String key) {
    ...
    private void SetBytePositions(String key, int row, int index) {
        BytePosition[] bytePositions = new BytePosition[3];

        for (int i = 0; i < bytePositions.length; ++i) {
            bytePositions[i] = new BytePosition(row, index);
